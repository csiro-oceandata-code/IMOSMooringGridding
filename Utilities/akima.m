...
%returns vector yy of interpolants at positions xx using data vectors xi,yi
%input data will be sorted in ascending xi: multiple values are not dealt with.
